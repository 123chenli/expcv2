...
from dpms.car_detector.SIFT import descriptor
from dpms.car_detector.SIFT import factor
from dpms.car_detector.SIFT import findextrema
from dpms.car_detector.SIFT import process
